    ...
    public static function get_my_notifications($limit = 0, $only_unseen = true, $only_count = false, $paginated = false)
    {
        ...
        foreach ($notifications as $notification) {
            if($notification->sender != null){
                ...
                $item['sender_photo']           = ($notification->sender->photo > 0 && $notification->sender->photo != null) ? uploaded_asset($notification->sender->photo) : static_avatar($notification->sender);
