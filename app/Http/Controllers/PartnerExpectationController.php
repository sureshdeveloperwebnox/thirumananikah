...
class PartnerExpectationController extends Controller
{
     ...
     */
     public function update(Request $request, $id)
     {
         ...
         //$partner_expectations->partner_city_id        = $request->partner_city_id;
         $partner_expectations->partner_city_id = is_array($request->partner_city_id) 
        ...
        : $request->partner_city_id;
         ...
         $partner_expectations->partner_max_age                = $request->partner_max_age;
