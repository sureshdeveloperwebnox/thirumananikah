...
class MemberController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $educations = Education::where('user_id',$member->id)->get();
        $careers = Career::where('user_id',$member->id)->get();
    ...
    public function edit($id)
    {
        ...
        return view('admin.members.edit.index', compact('member', 'countries', 'states', 'cities', 'religions', 'castes', 'sub_castes', 'family_values', 'marital_statuses', 'on_behalves', 'languages', 'additional_attributes'));
    }
