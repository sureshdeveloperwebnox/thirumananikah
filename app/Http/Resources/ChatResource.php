...
class ChatResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'receiver_photo' => $this->receiver->photo != null ? uploaded_asset($this->receiver->photo) : static_avatar($this->receiver),
            'sender_name' => $this->sender->first_name . ' ' . $this->sender->last_name,
            'auth_user_photo' =>  uploaded_asset(auth()->user()->photo) !== null ? uploaded_asset(auth()->user()->photo) : static_avatar(auth()->user()),
