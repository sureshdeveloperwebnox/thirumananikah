                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-start hov-bg-soft-primary">
                                        <a href="{{ route('notification_view', $notification->id) }}" class="media text-inherit">
                                            <span class="avatar avatar-sm mr-3">
                                                ...
                                                @else
                                                    <img src="{{ static_avatar($user_data) }}">
                                                @endif
                                            </span>
                ...
                <div class="align-items-stretch d-flex dropdown">
                    <a class="dropdown-toggle no-arrow text-dark" data-toggle="dropdown" href="javascript:void(0);" role="button" aria-haspopup="false" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            <span class="mr-md-2">
                                <img src="{{ uploaded_asset(Auth::user()->photo) }}" class="size-35px rounded-circle img-fit" height="36" width="36" onerror="this.onerror=null;this.src='{{ static_avatar(Auth::user()) }}';">
                            </span>
