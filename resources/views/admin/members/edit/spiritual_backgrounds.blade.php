    ...
    <div class="card-body">
      <form action="{{ route('spiritual_backgrounds.update', $member->id) }}" method="POST">
          ...
          <div class="form-group row">
              ...
              <div class="col-md-6">
                  <label for="member_caste_id">{{translate('Sect')}}</label>
          ...
          <div class="form-group row">
              <div class="col-md-6">
                  <label for="member_sub_caste_id">{{translate('Sub Sect')}}</label>
                  <!--<input type="text" class="form-control" name="member_sub_caste_id" id="member_sub_caste_id" placeholder="Enter Sub Sect" />-->
          ...
          @endphp
               <div class="form-group row">
                    <div class="col-md-6">
                          ...
                          <select class="form-control aiz-selectpicker" name="family_status_id" data-selected="{{ $member->spiritual_backgrounds->family_status_id ?? '' }}" data-live-search="true">
                              <option value="">{{translate('Select One')}}</option>
