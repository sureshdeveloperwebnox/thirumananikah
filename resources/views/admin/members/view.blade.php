                    ...
                    <div class="card-body">
                        <table class="table">
                            <tr>
                                ...
                                <th>{{ translate('Obligatory Fastings ') }}</th>
                                <td>{{ $member->hobbies->interests ?? '' }}</td>
                            </tr>
                            <tr>
                                <th>{{ translate('Giving Zakat/Sadaqah') }}</th>
                                <td>{{ $member->hobbies->music ?? '' }}</td>

                                <th>{{ translate('Reciding Quran ') }}</th>
                                <td>{{ $member->hobbies->books ?? '' }}</td>
                            </tr>
                            <tr>
                                <th>{{ translate('Religious Interests') }}</th>
                                <td>{{ $member->hobbies->movies ?? '' }}</td>

                                <th>{{ translate('Religious Studies') }}</th>
                        ...
                        <table class="table">
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>{{ $member->partner_expectations->partner_min_age ?? '' }}
                                </td>

                                <th>{{ translate('Max age') }}</th>
                                <td>{{ $member->partner_expectations->partner_max_age ?? '' }}
                                </td>
                            </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 @if(in_array($key, [0,1])) border-top @endif border-bottom" style="padding: 0.75rem;">
                                    <div class="row">
                                        ...
                                        <div class="col-6 fs-13">{{ additional_member_info($member->id, $attribute->id) }}</div>
                                    </div>
                                </div>
                                @endforeach
                            </div>
