<footer class="eb-footer-bg aiz-footer fs-13 mt-auto text-dark fw-400 pt-5 text-center">
    <div class="container">
        ...
        <!--                    <img src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" class="eb-footer-mylogo mw-100 h-30px h-md-40px" height="40">-->
        <!--                @else-->
        ...
        <div class="">
            <!--<h4 class="text-uppercase text-primary fs-14 border-bottom border-primary pb-4 mb-4"></h4>-->
            <div class="   row">
                
                <!----> 
                 <div class=" eb-footer-logo col-xl col-md-6 mb-4 ">
            <div class="col-xl col-md-3 mb-4 text-center mx-auto">
                <div class="logo mb-4">
                    <a href="{{ route('home') }}" class="d-inline-block py-15px">
                        @if(get_setting('footer_logo') != null)
                            <img src="{{ uploaded_asset(get_setting('footer_logo')) }}" alt="{{ env('APP_NAME') }}" class="eb-footer-mylogo mw-100 h-30px h-md-40px" height="40">
                ...
                <div class="col-xl col-md-3 mb-4">
                    ...
                    <ul class="eb-ul-style">
                        <li ><i class="las la-envelope mr-2"></i>thirumananikah @gmail.com</li>
                ...
                <div class="col-xl col-md-3 mb-4">
                    <div class="mb-3 eb-ftr-hdr">
                        ...
                        <span>{{ translate('Quick Search') }}</span>
                    </div>
                    <!--<div>{{ get_setting('footer_email') }}</div>-->
                    
                    <ul class="eb-ul-style">
                        <li><a class="eb-ul-style"  href="https://thirumananikah.com/privacy-policy">Privacy Policy</a></li>
                        <li><a class="eb-ul-style"  href="https://thirumananikah.com/terms-conditions">Terms and conditions</a></li>
                    </ul>
        ...
        <div class="d-flex justify-content-center">
            <h6 class=" text-white pb-4">© 2024 | Thirumana Nikah Matrimony</h6>
        </div>
