                ...
                <div class="col-xl-8 offset-xl-4">
                    <div class="px-3 row align-items-center">
                        <div class="col-md-8 col-xxl-9">
                            <h1 class="fs-24 fw-600 text-white">
                            ...
                            @if (Auth::user()->id != $user->id)
                                <div class="py-4 text-center border-md-left border-gray-600">
                                    ...
                                    @elseif($interest_onclick == 'do_response')
                                        ...
                                        <span id="interest_id_{{ $user->id }}" class="d-block fs-13">
                                        ...
                                        @if ($similar_profile->user != null)
                                            <a href="{{ route('member_profile', $similar_profile->match_id) }}"
                                                ...
                                                <div class="col-auto w-120px">
                                                    ...
                                                    <img @if ($profile_picture_show && $similar_profile->user->photo != null) src="{{ uploaded_asset($similar_profile->user->photo) }}"
                                                        @else
                                                        src="{{ static_avatar($similar_profile->user) }}" @endif
                                                        onerror="this.onerror=null;this.src='{{ static_avatar($similar_profile->user) }}';"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <table class="w-100">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td class="py-1 fw-600">{{ translate('Skin Color') }}
                                                                    </td>
                                                                    <td class="py-1">
                                ...
                                @if (get_setting('member_hobbies_and_interests_section') == 'on')
                                    ...
                                    <div class="pb-4 accordion-item">
                                        <div class="accordion-head c-pointer d-flex align-items-center mb-4"
                                            ...
                                            <div class="ml-4">
                                                <span
                                                    class="fs-18 fw-600 d-block">{{ translate('Religiousness') }}</span>
                                            </div>
                                        </div>
                                            ...
                                            <div class="border p-3">
                                                <div class="row no-gutters">
                                                    <div class="col-md-6">
                                                        <table class="w-100">
                                                            <tr>
                                                                <th class="py-1">{{ translate('Performing Salah') }}</th>
                                                                <td class="py-1">
                                                                    {{ $user->hobbies->hobbies ?? '' }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th class="py-1">{{ translate('Giving Zakat/Sadaqah') }}</th>
                                                                <td class="py-1">
                                                                    {{ $user->hobbies->music ?? '' }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th class="py-1">{{ translate('Religious Interests') }}</th>
                                                                <td class="py-1">
                                                                    {{ $user->hobbies->movies ?? '' }}
                                                                </td>
                                                            </tr>
                                                    ...
                                                    <div class="col-sm-6 border-sm-left ">
                                                        <table class="w-100 ml-sm-4">
                                                            <tbody>
                                                                <tr>
                                                                    <th class="py-1">{{ translate('Obligatory Fastings') }}
                                                                    </th>
                                                                    <td class="py-1">
                                                                ...
                                                                <tr>
                                                                    <th class="py-1">{{ translate('Reciding Quran ') }}</th>
                                                                    <td class="py-1">
                                                                        {{ $user->hobbies->books ?? '' }}
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th class="py-1">{{ translate('Religious Studies ') }}
                                                                    </th>
                                                                    <td class="py-1">
                                                ...
                                                <div class="row no-gutters">
                                                    <div class="col-md-6">
                                                        <table class="w-100">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <th class="py-1">{{ translate('Sub Sect') }}
                                                                    </th>
                                                                    <td class="py-1">
                                                    ...
                                                    <div class="col-sm-6 border-sm-left ">
                                                        <table class="w-100 ml-sm-4">
                                                            <tbody>
                                                                <tr>
                                                                    <th class="py-1">{{ translate('Sect') }}</th>
                                                                    <td class="py-1">
                                                                        {{ $user->spiritual_backgrounds->caste->name ?? '' }}
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        @foreach($additional_attributes as $key=>$attribute)
                                                            <div class="col-md-6 mb-3">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-6 fs-13">{{ additional_member_info($user->id, $attribute->id) }}</div>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                    </div>
                            ...
                            <div class="tab-pane fade" id="preference">
                                ...
                                <div class="">
                                    <table class="table table-responsive">
                                        ...
                                        <tr>
                                            <th>{{ translate('Min age') }}</th>
                                            <td>{{ $user->partner_expectations->partner_min_age ?? '' }}
                                            </td>

                                            <th>{{ translate('Max age') }}</th>
                                            <td>{{ $user->partner_expectations->partner_max_age ?? '' }}
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ translate('Sect') }}</th>
                                            <td>{{ $user->partner_expectations->caste->name ?? '' }}
                                            </td>
                                        </tr>

                                        <tr>
                                            <th>{{ translate('Sub Sect') }}</th>
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ translate('Performing Salah') }}</th>
                                            <td>{{ $user->partner_expectations->personal_value ?? '' }}
                                            </td>
                                        ...
                                        <!--    </td>-->
                                         ...
                                         <th>{{ translate('Preferred City') }}</th>
                                            <td>
                                                @php
                                                    $preferred_city = $user->partner_expectations->partner_city_id ?? '';
                                                    
                                                    // Check if $preferred_city is not empty
                                                    if (!empty($preferred_city)) {
                                                        // Convert the comma-separated string to an array
                                                        $city_ids = explode(',', $preferred_city);
                                                        
                                                        // Fetch the city names for the city IDs
                                                        $cities = \App\Models\City::whereIn('id', $city_ids)->pluck('name')->toArray();
                                                        
                                                        // Echo the city names as a comma-separated string
                                                        echo implode(', ', $cities);
                                                    }
                                                @endphp
                                            </td>
