<div class="card">
    ...
    @for ($i = 140; $i <= 200; $i++)
        ...
        @endphp
        <option value="{{ $i }}" 
    {{ isset($member->partner_expectations) && isset($member->partner_expectations->height) && $member->partner_expectations->height == $i ? 'selected' : '' }}>
        ...
        {{ translate('Not prefer to say') }}
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-control aiz-selectpicker" name="partner_city_id[]" id="partner_city_id" data-live-search="true" multiple>
